...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    boolean trovatoERimosso = listaDiStringhe.remove("duecento");
    // espressione ternaria: valuta la prima espressione e applica quello che c'è dopo
    // il ? se è vera, altriementi quello che c'è dopo il :
