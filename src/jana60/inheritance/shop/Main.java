...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Prodotto prod2 = new Prodotto(104, "Gazzelle", "Adidas", 169.0, 0.22);

    System.out.println(prod.getNome() + " " + prod.getMarca() + " " + prod.getPrezzoFormattato());

    Smartphone iphone = new Smartphone(101, "iphone", "Apple", 799.99, 0.18, "1232342342", "8GB");
    System.out
        .println(iphone.getNome() + " " + iphone.getMarca() + " " + iphone.getPrezzoFormattato());
