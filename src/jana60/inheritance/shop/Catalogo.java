  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < catalogo.length; i++) {
      ...
      do {
        ...
        System.out.println("1 per smarphone, 2 per televisore, 3 per cuffie");
      ...
      switch (scelta) {
        case "1":
          ...
          // creo un nuovo oggetto Smarphone
          Smartphone newSmartphone = new Smartphone(i, nomeInput, marcaInput, prezzoInput, ivaInput,
              imeiInput, memoriaInput);
          // aggiungo l'oggetto Smartphone al catalogo
        ...
        case "2":
          ...
          Televisore newTv = new Televisore(i, nomeInput, marcaInput, prezzoInput, ivaInput,
              dimensioniInput, smartInput);
          catalogo[i] = newTv;
          break;
        case "3":
          // cuffie
          System.out.print("Colore: ");
          String coloreiInput = scan.nextLine();
          ...
          Cuffie newCuffie = new Cuffie(i, nomeInput, marcaInput, prezzoInput, ivaInput,
              coloreiInput, wirelessInput);
